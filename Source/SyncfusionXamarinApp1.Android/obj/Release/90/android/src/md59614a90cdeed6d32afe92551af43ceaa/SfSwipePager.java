...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.Android.TabView.SfSwipePager, Syncfusion.SfTabView.XForms.Android", SfSwipePager.class, __md_methods);
	}


	public SfSwipePager (android.content.Context p0)
	{
		super (p0);
		if (getClass () == SfSwipePager.class)
			mono.android.TypeManager.Activate ("Syncfusion.Android.TabView.SfSwipePager, Syncfusion.SfTabView.XForms.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public SfSwipePager (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == SfSwipePager.class)
			mono.android.TypeManager.Activate ("Syncfusion.Android.TabView.SfSwipePager, Syncfusion.SfTabView.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public SfSwipePager (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == SfSwipePager.class)
			mono.android.TypeManager.Activate ("Syncfusion.Android.TabView.SfSwipePager, Syncfusion.SfTabView.XForms.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
