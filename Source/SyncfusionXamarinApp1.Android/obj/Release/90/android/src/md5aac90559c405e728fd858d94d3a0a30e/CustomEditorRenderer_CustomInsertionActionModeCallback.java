package md5aac90559c405e728fd858d94d3a0a30e;


public class CustomEditorRenderer_CustomInsertionActionModeCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SyncfusionXamarinApp1.Android.CustomEditorRenderer+CustomInsertionActionModeCallback, SyncfusionXamarinApp1.Android", CustomEditorRenderer_CustomInsertionActionModeCallback.class, __md_methods);
	}


	public CustomEditorRenderer_CustomInsertionActionModeCallback ()
	{
		super ();
		if (getClass () == CustomEditorRenderer_CustomInsertionActionModeCallback.class)
			mono.android.TypeManager.Activate ("SyncfusionXamarinApp1.Android.CustomEditorRenderer+CustomInsertionActionModeCallback, SyncfusionXamarinApp1.Android", "", this, new java.lang.Object[] {  });
	}
