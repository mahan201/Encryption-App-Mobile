...
public class CustomEditorRenderer_CustomSelectionActionModeCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SyncfusionXamarinApp1.Android.CustomEditorRenderer+CustomSelectionActionModeCallback, SyncfusionXamarinApp1.Android", CustomEditorRenderer_CustomSelectionActionModeCallback.class, __md_methods);
	}


	public CustomEditorRenderer_CustomSelectionActionModeCallback ()
	{
		super ();
		if (getClass () == CustomEditorRenderer_CustomSelectionActionModeCallback.class)
			mono.android.TypeManager.Activate ("SyncfusionXamarinApp1.Android.CustomEditorRenderer+CustomSelectionActionModeCallback, SyncfusionXamarinApp1.Android", "", this, new java.lang.Object[] {  });
	}
